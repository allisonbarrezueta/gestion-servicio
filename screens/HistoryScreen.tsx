    ...
    return (
        <TouchableOpacity
            ...
            <View style={{ flexDirection: "row", justifyContent: "space-between", alignItems: "center", marginBottom: 8 }}>
                ...
                {user.type !== "supplier" && <Icon name="chevron-right" size={28} color="#40667f" />}
            </View>
            ...
            <View
                style={{
                    ...
                    alignItems: "center",
                    marginBottom: user.type === "supplier" ? 0 : 12,
                }}>
            ...
            {user.type !== "supplier" && (
                <View style={{ flexDirection: "row", justifyContent: "flex-end", alignItems: "center" }}>
                    <View
                        ...
                        <Text style={{ fontSize: 16, color: "white", fontWeight: "600" }}>Opinar</Text>
                    </View>
                </View>
            )}
        </TouchableOpacity>
    ...
    return (
        <SafeAreaView style={styles.container}>
            <View style={{ width: "100%", flex: 1, paddingVertical: 22 }}>
                <Text style={{ fontSize: 24, fontWeight: "600", marginBottom: 18, color: "#4c5763" }}>Historial de Servicios</Text>
