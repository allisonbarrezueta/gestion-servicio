...
import { StyleSheet, Text, TouchableOpacity, View, ActivityIndicator, FlatList, RefreshControl, SafeAreaView } from "react-native";
...
export default function ScheduledScreen({ navigation }: any) {
    ...
    return (
        <SafeAreaView style={styles.container}>
            <View style={{ width: "100%", flex: 1, paddingVertical: 22 }}>
                <Text style={{ fontSize: 24, fontWeight: "600", marginBottom: 18, color: "#4c5763" }}>Servicios Programados</Text>
